...
pub mod ffi {
    ...
    unsafe extern "C++" {
        // Generator functions
        fn PolyGenNullParams() -> UniquePtr<PolyParams>;
    }
...
mod tests {
    ...
    #[test]
    fn PolyWrapper() {
        // Create null params first
        let poly_params = ffi::PolyGenNullParams();

        // Test that we can create a params object
        assert!(!poly_params.is_null());
    }
}
